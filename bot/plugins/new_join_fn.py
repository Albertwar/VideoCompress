    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
               await message.reply_text(
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/bots_ask).",
                   parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/bots_ask).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Developer', url='https://t.me/BANDU_OF_TG'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('HELPER', url='https://t.me/N_A_V_I_P_A_V_I') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
